...
def main():
    ...
    parser.add_argument('--load_data', type=str, default=None, help='Path to any subset or dataset compiled by koopstrap to test, if None we use the test set from subset of train')
